...
//                var button1 = data?.getBooleanExtra(EXTRA_BUTTON1, false)
//                var button2 = data?.getBooleanExtra(EXTRA_BUTTON2, false)
//                var button3 = data?.getBooleanExtra(EXTRA_BUTTON3, false)
//                var button4 = data?.getBooleanExtra(EXTRA_BUTTON4, false)
//                var button5 = data?.getBooleanExtra(EXTRA_BUTTON5, false)
//                var button6 = data?.getBooleanExtra(EXTRA_BUTTON6, false)
//                var button7 = data?.getBooleanExtra(EXTRA_BUTTON7, false)
//
//                with(binding) {
////                    Last Order
...
//                intentToOrder.putExtra(RegisterActivity.EXTRA_USERNAME, username)
